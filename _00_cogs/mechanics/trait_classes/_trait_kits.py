...
trait_kits_dict = {
    ...
    'Rivenborne':['Rivenborne', 'A mighty race of great strength, the Barheim have built an empire to last the test of time.',
              'on_play', Rivenborne(),
             None, None, {'Health':2}, None, ['1d4', '1d8']],
    ...
    'Worker':['Worker', 'The mark of a Worker', 'on_play', Worker(), None, None, None, None, None],
    'Warrior':['Warrior', 'The mark of a Warrior', 'on_play', Warrior(), None, None, None, None, None],
    'Guardian':['Guardian', 'The mark of a Guardian', 'on_play', Guardian(), None, None, None, None, None],
    'Ranger':['Ranger', 'The mark of a Ranger', 'on_play', Ranger(), None, None, None, None, None],
    'Scout':['Scout', 'The mark of a Worker', 'on_play', Scout(), None, None, None, None, None],
